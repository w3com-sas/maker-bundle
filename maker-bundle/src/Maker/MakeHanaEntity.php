 ...
 */
final class MakeHanaEntity extends AbstractMaker implements InputAwareMakerInterface
{
    private $fileManager;
    ...
    {
        return 'make:HanaEntity';
    }

    public function configureCommand(Command $command, InputConfiguration $inputConf)
    {
        $command
            ->setDescription('Creates or updates a hana entity class.')
            ->addArgument('name', InputArgument::REQUIRED, sprintf('Sap Table name of the HanaEntity to create or update (e.g. <fg=BusinessPartner>%s</>)', Str::asClassName(Str::getRandomTerm())))
